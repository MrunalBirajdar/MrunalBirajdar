...
<body>
	...
	<?php
	 include 'navbar.php';
    ?>
	<br><br><form method="POST" action="" enctype="multipart/form-data" class="value">
		 ...
		 if($imagepath)
		  {
		 	...
		 	$insert=mysqli_query($conn,"INSERT INTO mrunal1(title, image, content,link,datep) VALUES ('$title','$picture','$content','$link','$datep')");
		 	if($insert)
		 	{
		 		echo"good";
