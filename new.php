   ...
   <body>
        ...
        <li><a href="logout.php">LOGOUT</a></li>
         ...
         if(isset($_SESSION['newid']));
         {
          ...
          $pid=$_SESSION['newid'];
          echo $pid;
          $accept=mysqli_query($conn,"SELECT * FROM mrunal1 WHERE id='$pid'");
              ...
              if(isset($_POST['update']))
                {
                  ...
                  if($image1){
                   ...
                   echo $picture1;
                    ...
                    $update=mysqli_query($conn,"UPDATE mrunal1 SET title='$title1',content='$comment1',image='$picture1',link='$weblink1',datep='$datep' WHERE id='$id'");
                    if($update)
                    {
                      echo"<script>";
                ...
                {
                  $id=$_POST['id'];
                  $delete=mysqli_query($conn,"DELETE FROM mrunal1 WHERE id='$id'");
                      if($delete)
                      {
                        echo"<script>";
                        echo"document.location.replace('./index.php')";
